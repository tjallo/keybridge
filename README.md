...
Enable Actions and Packages for the Gitea repository. Create a personal access token for `tjallo` with package read and write permission. Add the token as the repository Actions secret `REGISTRY_TOKEN`.
